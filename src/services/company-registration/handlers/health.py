"""Health check HTTP API — servicio: apro-click-admin-company-registration"""
...
SERVICE_NAME = "apro-click-admin-company-registration"


@app.get("/api/v1/health-company-registration")
