...
STAFF_ROLES_CHAT = frozenset({"SUPERADMIN", "ADMIN", "SALES"})
...
def require_chat_staff(user: dict[str, Any]) -> None:
    if user.get("role") not in STAFF_ROLES_CHAT:
        raise PermissionError("Sin permisos para el chat de empresa")
